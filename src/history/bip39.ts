/**
 * BIP-39's English wordlist, as `bitcoin/bips` publishes it in
 * `bip-0039/english.txt` (SHA-256 2f5eed53…3b24dbda). Every wallet that shows a
 * twelve- or twenty-four-word phrase draws it from this list.
 */
...
you young youth zebra zero zone zoo`.split(/\s+/),
)
