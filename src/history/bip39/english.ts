/** BIP-39's English wordlist, as `bitcoin/bips` publishes it in `bip-0039/english.txt` (SHA-256 2f5eed53…3b24dbda). */
export const WORDS = `abandon ability able about above absent absorb abstract absurd abuse access
