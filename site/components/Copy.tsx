  ...
  return (
    <span className="ml-auto flex flex-none items-center">
      <button
        ...
        className="relative flex cursor-pointer items-center gap-1.5 rounded-[3px] border border-rule px-2 py-0.5 font-mono text-[0.75rem] leading-4 uppercase tracking-[0.08em] text-dim transition-colors after:absolute after:inset-x-0 after:-inset-y-[13px] after:content-[''] hover:border-accent-dim hover:text-accent"
      >
        <svg
          aria-hidden="true"
          viewBox="0 0 24 24"
