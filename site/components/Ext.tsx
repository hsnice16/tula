...
export function Ext({
  ...
  /** For a link whose content is an image: the arrow has nothing to follow. */
  bare?: boolean
}) {
  return (
    <a target="_blank" rel="noreferrer" {...props}>
      {children}
      {bare ? null : (
        // No whitespace before this tag: a space here is a wrap point, and
        // would let the icon fall to its own line, orphaned from the last word.
        <svg
          aria-hidden="true"
          viewBox="0 0 24 24"
          fill="none"
