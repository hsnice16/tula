...
Coinbase, Stripe, Circle — and the plain token balances every address holds.
...
- [02 · Binance connector](02-binance-connector.md) — done
- [03 · Chain coverage](03-chain-coverage.md) — planned
- [04 · Stripe connector](04-stripe-connector.md) — done
- [05 · Coinbase and Circle](05-coinbase-and-circle.md) — done
